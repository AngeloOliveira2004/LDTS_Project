...
class SettingsModelTest {
    ...
    void testDefaultConstructor() {
        ...
        assertEquals(Integer.valueOf(3), settingsModel.getValuesMap().get("Music Volume:"));
        assertEquals(Integer.valueOf(5), settingsModel.getValuesMap().get("Difficulty:"));
    }
    ...
    void testLowerValueMap() {
        ...
        assertEquals(Integer.valueOf(2), settingsModel.getValuesMap().get("Music Volume:"));
